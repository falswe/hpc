...
double trapezoid(double endpoint_l, double endpoint_r, int n_trapezoids) {
...
#pragma omp parallel num_threads(n_threads) reduction(+ : result_global)
    result_global += trapezoid(endpoint_l, endpoint_r, n_trapezoids);
